# -*- coding: utf-8 -*-
"""
Created on Fri Jan 12 11:07:03 2024
...
time_str = '2018.09.30 01UTC'                      #time_str을 조정해서 초기 시간 조정
...
ort_session = ort.InferenceSession(model_dir, sess_options=options, providers=[('CUDAExecutionProvider', cuda_provider_options)])
